...
#With 600 questions (trials), the p-value is less than .01. It would make it unlikely that students will get 55% or higher by guessing each question. 
```
...
#probability of producing 75% or greater on this test by guessing each question
