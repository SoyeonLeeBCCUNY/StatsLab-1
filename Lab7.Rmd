...
#With 600 questions (trials), the p-value is less than .01, which would make it unlikely that students will get 55% or higher by guessing each question. 
```
