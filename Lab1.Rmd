...
```{r}
# sum of the sequenced numbers from 100 to 1000 with an interval of 100
sum(seq(100,1000,100)) 
```

2. Compute the sum of these numbers (1,3,2,4,3,5,4,3,4,5,6,5,6,7,6,5,6,5,4,3,4,5)
```{r}
#sum of the collection of numbers
...
```{r}
#put numbers 1-10 in the first 10 positions of a
a<-c()
for(i in 1:10){
  a[i]<-i
}
...
#recommended options to write a custom sequence generator function using a for loop
...
#product of the two components and return value
...
#second option
#gauss's formula is calculated as total_sum
#the total_sum is the returned value
gauss_meth<-function(from,to,by){
